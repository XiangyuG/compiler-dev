...
static void lex_finish_expression() {
    ...
    if (lex_process->current_expression_count < 0) {
        compiler_error(lex_process->compiler, "You closed an experssion that you never opened\n");
    }
}
...
struct token *read_next_token()
{
    ...
    NUMERIC_CASE:
        ...
        break;
    OPERATOR_CASE_EXCLUSING_DIVISION:
    ...
    case EOF:
        break; // we have finished lexical analysis on the file
    default:
